---
name: trestle-resolvers
description: Writes Trestle resolvers that turn facts into graph entities, aliases, and claims with evidence. Use when editing trestle/resolvers/*.ts, joining facts, or handling unresolved references.
---
