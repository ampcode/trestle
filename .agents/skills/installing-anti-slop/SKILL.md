---
name: installing-anti-slop
description: Installs and configures the generic and optional Effect anti-slop Oxlint plugins in a local TypeScript or JavaScript repository. Use when adding anti-slop lint rules, configuring Oxlint, or migrating an existing anti-slop setup.
---
